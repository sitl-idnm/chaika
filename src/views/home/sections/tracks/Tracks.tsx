  ...
  return (
    <section className={styles.root} id="tracks">
      <div className={styles.wrap}>
        <h2 className={styles.title}>4 трассы для всех возрастов</h2>

        <div className={styles.desc}>
          <RopeDeco />
          <p>
            Всего в парке 39 этапов-препятствий на 28 площадках. Трассы
            проложены между деревьями, и органично вписаны в природный ландшафт.
          </p>
          <p className={styles.withIcon}>
            <Icon name="forest" size={32} className={styles.descIcon} />
            Активный отдых дает большой заряд энергии, позволяет провести время
            весело и с пользой. Верёвочный парк «Чайка» в Королёве — это открытый
            развлекательный комплекс на природе.
          </p>
          <p>
            Верёвочные трассы парка проложены между деревьями, под открытым
            небом. Конструкция для лазания представляет собой многочисленные
            этапы-препятствия, мостики, канаты и сетки, объединенные в единую
            систему. Посещение маршрутов осуществляется с использованием
            страховочного снаряжения и оборудования мировых лидеров Petzl, Kong
            VENTO, поэтому наши гости чувствуют себя максимально безопасно.
          </p>
        </div>
        ...
        <div className={styles.trampOuter}>
          <div className={styles.trampInner}>
            ...
            <p>
              Большой батут под открытым небом подходит для детей от 4 лет и даже
              для взрослых. Для маленьких посетителей — мягкое покрытие и
              безопасные борта. Отличный способ выплеснуть энергию, повеселиться
              и получить заряд бодрости. Можно купить отдельно или в дополнение к
              трассам.
            </p>
            <TrackCta />
          </div>
